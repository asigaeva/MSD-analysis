...
for i in range(50):
    ...
    fname = "F:\My Drive\Work\!Work\Papers\FND tracking\datasets\simulated\combination of the basic ones\moving confinement\confinement does not stop\\fast_constant movement\\confined_"+str(i)+".tck"
    f_out = open(fname, "w+")
